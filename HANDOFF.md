...
## 2026-07-26 · 노트북 · 브랜치 `agent/archive-enter-wait-cleanup-20260726` (Enter 대기 통합·죽은 코드 제거)
...
- 미니PC 반영 시 정본 절차대로 사전/사후 healthcheck와 CollectLoop 단일 인스턴스를 확인한다.
- 남은 완전 로그오프 사각지대는 운영 구조 변경이므로 별도 승인 작업으로 유지한다.
