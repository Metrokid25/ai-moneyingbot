...
**최종 갱신:** 2026-07-26 (RAG 노트북 인수인계 정본 연결) / **권위 기준:** `origin/main` + `HANDOFF.md` 최신 항목

> **2026-07-26 노트북 RAG 작업자:** 채팅 프롬프트를 수동 편집하지 말고
> [`docs/RAG_LAPTOP_HANDOFF.md`](docs/RAG_LAPTOP_HANDOFF.md)를 정본으로 읽는다.
> 해당 문서에는 clean 시작 경로, 미병합 RAG 하드닝, 보호 대상 dirty checkout,
> 첫 점검 명령과 보고 형식이 기록되어 있다.
